      ...
      <div class="py-5">
        ...
        <div class="col-lg-6 mx-auto">
          ...
          <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            ...
            @elseif(isHomePage('charity'))
            <a href="{{ route('home').'#search' }}" class="btn btn-outline-info btn-lg px-4 me-sm-3 fw-bold" tabindex="-1" role="button" aria-disabled="true">Start Another One</a>
            @endif
          </div>
        </div>
      </div>
